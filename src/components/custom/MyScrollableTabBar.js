...
export default class MyScrollableTabBar extends Component {
  constructor(props) {
    super(props)
  ...
  renderTab(name, page, isTabActive, onPressHandler, onLayoutHandler) {
    ...
    const fontFamily = isTabActive ? Fonts.medium : Fonts.regular
...
MyScrollableTabBar.defaultProps = {
  scrollOffset: 52,
  activeTextColor: colors.colorPrimary,
