        ...
        return (
            <TouchableOpacity
                ...
                {props.placeholderIcon && props.placeholderPosition != 'right' ?
                    <Image source={props.placeholderIcon} style={{ height: 18, width: 18, marginLeft: 10, resizeMode: 'contain' }} /> : null}
                <TextRegular
                    style={[{
                        flex: 1,
                        // margin: 4,
                ...
                />
                {props.placeholderIcon && props.placeholderPosition == 'right' ?
                    <Image source={props.placeholderIcon} style={{ height: 18, width: 18, marginRight: 10, resizeMode: 'contain' }} /> : null}
    ...
    return (
        <TouchableOpacity
            ...
            <TextInput
                ...
                placeholderTextColor={props.placeholderTextColor || colors.colorBlack}
            />
            {props.placeholderIcon && props.placeholderPosition == 'right' ?
                <Image source={props.placeholderIcon} style={{ height: 18, width: 18, marginRight: 10, resizeMode: 'contain' }} /> : null}
        </TouchableOpacity>
